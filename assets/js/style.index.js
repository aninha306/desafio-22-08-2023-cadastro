class User {
    constructor(name, email, date, city, phone, cpf) {
        ...
        this.phone = phone;
        this.cpf = cpf;
        this.calculatorage = this.calculatorAge();
        this.getZodiacSign = this.getZodiacSign();
    }
    calculatorAge() {
        const todays = new Date();
        const todayYear = todays.getFullYear();
        console.log(todayYear);

        const dateInput = this.date;
        const test = new Date(dateInput);
        const birthdayYear = test.getFullYear();
...
function createUser() {
    ...
    const user = new User(name, email, date, city, phone, cpf);
...
function isAnyInputEmpty() {
    ...
    if (name == '' || email == '' || date == '' || city == '' || phone == '' || cpf == '') {
        return false
    } else {
        return true
    }
